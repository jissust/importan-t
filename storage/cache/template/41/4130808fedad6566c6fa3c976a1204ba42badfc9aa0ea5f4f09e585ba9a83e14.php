...
class __TwigTemplate_d7eb2e6345ad2127759aa35f8de637f015af065187e48e19ddf360ae1a4c45be extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"panel-body\">
        ...
        if (($context["location"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["locations"]) {
                ...
                // line 55
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["locations"], "location_id", [], "any", false, false, false, 55), ($context["selected"] ?? null))) {
                    // line 56
                    echo "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["locations"], "location_id", [], "any", false, false, false, 56);
                    echo "\" checked=\"checked\" />
                    ";
                } else {
                    // line 58
                    echo "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["locations"], "location_id", [], "any", false, false, false, 58);
                    echo "\" />
                    ";
                }
                // line 59
                echo "</td>
                  <td class=\"text-left\">";
                // line 60
                echo twig_get_attribute($this->env, $this->source, $context["locations"], "name", [], "any", false, false, false, 60);
                echo "</td>
                  <td class=\"text-left\">";
                // line 61
                echo twig_get_attribute($this->env, $this->source, $context["locations"], "address", [], "any", false, false, false, 61);
                echo "</td>
                  <td class=\"text-right\"><a href=\"";
                // line 62
                echo twig_get_attribute($this->env, $this->source, $context["locations"], "edit", [], "any", false, false, false, 62);
                echo "\" data-toggle=\"tooltip\" title=\"";
...
";
    ...
    {
        return new Source("", "localisation/location_list.twig", "");
    }
}
